...
const Footer: React.FC = () => {
  ...
  const socialLinks = [
    {
      name: 'LinkedIn',
      url: 'https://www.linkedin.com/in/r-gopinathreddy-reddyvari-8a0a1a324?lipi=urn%3Ali%3Apage%3Ad_flagship3_profile_view_base_contact_details%3BAM3vDe6rSOaIYRss%2FY%2F%2BxA%3D%3D',
      icon: '💼'
    },
    {
      name: 'GitHub',
